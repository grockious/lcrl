...
# an example automaton for "wood then grass then iron then tool_shed" or
# "F (wood & XF (grass & XF (iron & XF tool_shed)))"
...
minecraft_3 = LDBA(accepting_sets=[[4]])
...
LDBA.step = step.__get__(minecraft_3, LDBA)
